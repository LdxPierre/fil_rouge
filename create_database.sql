...
CREATE TABLE product(
   ...
   product_desc TEXT,
   img VARCHAR(255) ,
   unit_price_ht DECIMAL(13,4)   NOT NULL,
   unit_supplier_price_ht DECIMAL(13,4)   NOT NULL,
   stock INT NOT NULL,
...
CREATE TABLE orders(
   ...
   payement VARCHAR(10)  NOT NULL CHECK (payement = 'virement' OR payement = 'cheque' OR payement = 'online'),
   ...
   bill_postal_code VARCHAR(10)  NOT NULL,
